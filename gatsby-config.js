    ...
    projects: [
      {
        ...
        tags: ['React', 'React Router', 'Stylus'],
      ...
      },
      {
        ...
        description: 'Boilerplate for React application using Parcel, Babel, and ESLint',
